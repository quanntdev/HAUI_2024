      ...
      <div>
                      ...
                      <Box className={styles["invoice-right"]}>
                        <Grid textAlign="right" item xs={12}>
                          ...
                          <Box className={styles["invoice-group-right"]}>
                            <Grid item xs={12}>
                              <Typography className={styles["box-title"]}>
                                7F MITEC Tower, Dương Đình Nghệ, Yên Hoà, Cầu
                                Giấy, Hà Nội 100000
                              </Typography>
                            </Grid>
                          </Box>
        ...
        <Card ref={tabRef} sx={{ width: "100%" }}>
          <Box>
            ...
            >
              <Tab label={trans.menu.lognote} {...setTabId(0)} />
              <Tab label={trans.menu.payment} {...setTabId(1)} />
              <Tab label={trans.menu.task} {...setTabId(2)} />
            </Tabs>
          </Box>
          <TabPanel value={tabValue} index={0}>
            <Box style={{ padding: 16 }}>
              <LogNote
                ...
                object={dataDetailInvoice}
                logNotes={dataDetailInvoice?.logNotes}
                objectName="invoices"
                getObject={getDetailInvoice}
              />
            </Box>
          </TabPanel>
          <TabPanel value={tabValue} index={1}>
            <TabPanelPaymentList dataListPayment={dataDetailInvoice?.payment} />
          </TabPanel>
          <TabPanel value={tabValue} index={2}>
            <TabPanelTaskList
              paramObject="invoiceId"
              idObject={invoiceId}
